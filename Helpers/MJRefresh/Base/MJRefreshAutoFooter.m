...
- (void)scrollViewContentOffsetDidChange:(NSDictionary *)change
{
    ...
    if (_scrollView.mj_insetT + _scrollView.mj_contentH > _scrollView.mj_h) { // 内容超过一个屏幕
        ...
        //****控制上滑开始刷新的位置
        if (_scrollView.mj_offsetY >= _scrollView.mj_contentH - _scrollView.mj_h + self.mj_h * self.triggerAutomaticallyRefreshPercent + _scrollView.mj_insetB - self.mj_h-([UIScreen mainScreen].bounds.size.height/2)) {
            // 防止手松开时连续调用
