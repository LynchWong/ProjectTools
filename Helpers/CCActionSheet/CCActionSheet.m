            ...
            otherButtonTitles:(NSString *)otherButtonTitles, ...
{
    ...
    if (self) {
        ...
        _maxCount = [_otherButtons count]+2;
        //初始化子视图
        [self installSubViews];
...
- (void)show
{
    ...
    self.tableView.frame = CGRectMake(0.0f,[UIScreen mainScreen].bounds.size.height, [UIScreen mainScreen].bounds.size.width, self.tableViewHeight);
...
-(UIView *)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section {
    ...
    if(section == 0 && self.titleText) {
        ...
        UILabel *label = [[UILabel alloc]initWithFrame:CGRectMake(0, 0, self.tableView.bounds.size.width, ACTION_SHEET_BTN_HEIGHT)];
        [label setFont:[UIFont fontWithName:@"HelveticaNeue-Bold" size:12]];
    ...
    if(section == 1 && self.cancelText) {
        ...
        [view setBackgroundColor:self.backgroundView.backgroundColor];
        view.alpha = self.backgroundView.alpha;
