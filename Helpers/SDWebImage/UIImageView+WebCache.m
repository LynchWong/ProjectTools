...
- (void)sd_setImageWithURL:(nullable NSURL *)url placeholderImage:(nullable UIImage *)placeholder {
    ...
    UIImage *placeholder_old = [[SDImageCache sharedImageCache] imageFromDiskCacheForKey:[url absoluteString]];//以前加载过的就直接用 避免闪烁
    
    [self sd_setImageWithURL:url placeholderImage:placeholder_old!=nil?placeholder_old:placeholder options:0 progress:nil completed:nil];
    
    placeholder_old = nil;
}

- (void)sd_setImageWithURL2:(nullable NSURL *)url placeholderImage:(nullable UIImage *)placeholder {
